...
# Clearance ≥ 0.85 m from all obstacles (pillars, divider walls, cylinders).
# y=-3.0 row removed — coincides with horizontal divider walls at y=±3.0.
# Bottom zone uses y=-5.0 and y=-7.5/-8.0 to clear divider walls and cylinders.
_INSPECTION_GRID = [
    # Top zone (y > 3.1): above divider walls
    (-6.0, 7.0), (-2.0, 7.0), (2.0, 7.0), (6.0, 7.0),
    (-6.0, 4.0), (-2.0, 4.0), (2.0, 4.0), (6.0, 4.0),
    # Middle zone (|y| < 2.9): between divider walls
    (-6.0, 1.0), (6.0, 1.0),
    (-4.0, -1.0), (4.0, -1.0),
    # Bottom zone (y < -3.1): below divider walls
