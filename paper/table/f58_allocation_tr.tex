\begin{table}[t]
\centering
\caption{F58 (P0 geodezik oracle + P1R terminal yük onarımı) Nav2-bağımsız
allocation-only sonuçları (hücre başına 100 tohum). Navigasyon deterministik
olarak başarılıdır; mesafe, ortak şişirilmiş occupancy map üzerindeki geodezik
yol uzunluğudur.}
