\begin{table*}[t]
\centering
\caption{Deadline scenario results (deadline\_pressure) at the primary 5-robot / 25-task scale; $n{=}20$ runs (seeds) per cell. DVR: deadline violation rate. Best value per column in \textbf{bold}. Significance vs AHE-MRTA* (Bonferroni-corrected Mann-Whitney U).}
\label{tab:deadline}
\small
