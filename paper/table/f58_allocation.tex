\begin{table}[t]
\centering
\caption{AHE-MRTA Nav2-independent allocation-only results (100 seeds per
cell). Navigation succeeds deterministically; distance is the geodesic path
length on the shared inflated occupancy map.}
