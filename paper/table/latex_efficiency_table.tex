\begin{table}[t]
\centering
\caption{Efficiency metrics (Gazebo, 3-robot scale; densities 9/15/24 pooled, $n{=}15$ per cell). WLBal: all-robot Jain workload balance; Lat: mean decision latency; Msgs: allocation messages; Dist: total travel distance. Best value per column (within scenario) in \textbf{bold}.}
