\begin{table}[t]
\centering
\caption{Efficiency metrics (Gazebo, 3-robot scale; densities 9/15/24 pooled, $n{=}15$ per cell). WLBal: Jain workload balance; Lat: mean decision latency; Msgs: allocation messages; Dist: total travel distance.}
