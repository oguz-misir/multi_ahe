...
\title{Dinamik Çok Robotlu Görev Tahsisi için\\
  Ekosistem Güdümlü Sezgisel Seçimi}
...
%==============================================================================
\begin{abstract}
Dinamik çok robotlu görev tahsisi, uygulanabilir atamaları korurken görev
gelişlerine, son teslim baskısına ve robot arızalarına uyum sağlamalıdır. Bu
çalışma, beş yorumlanabilir tahsis paradigması arasından seçim yapan merkezi,
olay tetiklemeli bir hiper-sezgisel olan AHE-MRTA'yı sunar. Arıza ve son teslim
koşulları kendilerine ayrılmış politikaları etkinleştirir; diğer durumlarda
kalıcı baskınlık skorları politika seçimini belirler. Ortak geodezik varış
süresi kestirimleri, yürütülen hedef kilidi ve sınırlı terminal yük onarımı,
etkin hedefleri kesmeden uygulanabilir robot kuyrukları üretir. Tüm işlem
hattı, navigasyondan bağımsız benzetim, stokastik navigasyon vekili ve 480
kapalı çevrim ROS\,2/Nav2 Gazebo koşusunda değerlendirilmiştir. Birincil 5
robot/25 görev ölçeğinde AHE-MRTA, üç senaryonun tamamında tüm görevleri
tamamlamıştır. Son teslim baskısında en güçlü taban çizgisinin $0.578$ değerine
karşı $0.650$ tamamlama--zamanlılık bileşik skoru elde etmiş ve son teslim ihlal
oranını $0.422$'den $0.350$'ye indirmiştir. Geodezik varış süresi kestirimi,
vekil uygunluğunu $1.83$--$4.10$ yüzde puan iyileştirmiş; kapalı çevrim tahsis
gecikmesi $0.81$--$1.33$~ms olmuştur. Eşleşmiş ablasyonlar, sabit EDF ve
sahipsiz-görev-önce politikalarının birincil sonucu düşürdüğünü göstermiştir.
Bununla birlikte, uygulanan geçiş kuralı baskın uzamsal-açgözlü geri dönüş
politikasından ölçülebilir biçimde ayrışmamaktadır; dolayısıyla nedensel iddia,
uygun politika portföyüne erişimle sınırlıdır.
\end{abstract}
...
uygun olduğu söylenemez. Bu aileler çözüm kalitesi, gecikme, haberleşme,
kararlılık ve yorumlanabilirlik arasında farklı dengeler kurar.
...
Bölüm~\ref{sec:problem} çevrim içi tahsis problemini
...
\begin{figure}[t]
  ...
  Mavi kareler tohum\,1 için görev hedeflerini, kırmızı üçgenler robot
  başlangıç konumlarını gösterir; soluk noktalar ise hedeflerin seçildiği
  42 noktalı aday muayene ızgarasıdır. Tüm ara noktalar engelsizdir.}
...
\input{table/latex_main_table_tr.tex}

\input{table/latex_deadline_table_tr.tex}
