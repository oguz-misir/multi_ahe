...
\begin{figure}[t]
  ...
  3-robot scale; panels (a)--(b) use the 15-task density and panels (c)--(e)
  pool the three densities. Time is measured from each run's first task activation, so
...
(xi) \textbf{Priority is expressed twice in the cost.} The additive term
