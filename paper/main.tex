...
not an iterative Euclidean projection; the sparse $A$ and $S$ are given in
Table~\ref{tab:as-matrices}. Functionally this is a fixed, low-dimensional
...
(x) \textbf{Missing physical selector ablation:} The four-method
