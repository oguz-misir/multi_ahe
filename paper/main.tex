...
%==============================================================================
\begin{abstract}
A mobile robot team is rarely handed all of its work up front: work appears,
expires, and changes hands while the fleet is moving. Online
...
every regime. We present AHE-MRTA, which chooses allocation behaviour
online rather than at design time. Its selector, Ecosystem-Driven Paradigm
Selection (EDPS), maps four observable signals---task density, robot
availability, deadline pressure, and recent failure rate---onto a small
repertoire of fixed, interpretable behaviours, with deterministic overrides
for failure and deadline regimes, a dominance dynamic elsewhere; a
geodesic-ETA oracle and bounded terminal load repair complete it. We evaluate
on three layers of realism: an allocation-only campaign, a
stochastic navigation proxy (500 seeds), and closed-loop Gazebo/ROS\,2 Nav2
experiments with 3, 5, and 10 TurtleBot3 robots (300 runs). The first two do
...
rankings, and the selector is not isolated from other
